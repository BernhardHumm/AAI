...
{width=65%}
![Fig. 8.8: Autoencoder NN for anomaly detection](images/AD_AE.png)

An autoencoder neural network is symmetric with the input layer identical to the output layer. The hidden layers implement an encoder (compressing the input data) and a decoder (decompressing the compressed data representation). It is trained to minimize the reconstruction error. 
